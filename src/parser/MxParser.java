...
public class MxParser extends Parser {
	...
	public static final int
		...
		Shr=51, AndAnd=52, OrOr=53, Not=54, Identifier=55, DecimalInt=56, FStringHead=57, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"DecimalInt", "FStringHead", "FStringBody", "FStringTail", "FStringAtom", 
			"StringConst", "Whitespace", "Newline", "BlockComment", "LineComment"
		};
	}
